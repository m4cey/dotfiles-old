...
class UI {
    constructor(ltPlayer) {
        ...
        new Spicetify.Topbar.Button("Listen Together", `<svg role="img" height="16" width="16" viewBox="0 0 16 16" fill="currentColor">${Spicetify.SVGIcons["collaborative"]}</svg>`, () => this.openMenu());
